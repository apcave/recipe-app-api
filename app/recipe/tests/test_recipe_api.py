...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_partial_update_recipe(self):
        ...
        orginal_link = 'https://sample.com/recipe.pdf'
    ...
    def test_update_recipe_assign_tag(self):
        """Test assigning tags when updating a recipe."""
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('10.20'),
            'ingredients': [{'name': 'Chicken'}, {'name': 'Curry'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        ingredient_tumeric = Ingredient.objects.create(
            user=self.user, name='Tumeric')
        payload = {
            'title': 'Salted Caramel',
            'time_minutes': 30,
            'price': Decimal('5.10'),
            'ingredients': [{'name': 'Salt'}, {'name': 'Tumeric'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
        ...
        recipe = recipes[0]
        self.assertEqual(recipe.ingredients.count(), 2)
        self.assertIn(ingredient_tumeric, recipe.ingredients.all())
        for ingredient in payload['ingredients']:
            exists = recipe.ingredients.filter(
                name=ingredient['name'],
                user=self.user,
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test assigning ingredients when updating a recipe."""
    ...
    def test_filter_by_ingredients(self):
        ...
        i2 = Ingredient.objects.create(user=self.user, name='Cauliflower')
